...
RUN mkdir -p /opt/twofishes \
    && wget http://twofishes.net/binaries/server-assembly-0.84.9.jar -P /opt/twofishes \
...
CMD java -jar /opt/twofishes/server-assembly-0.84.9.jar --hfile_basepath /opt/twofishes/2015-03-05-20-05-30.753698